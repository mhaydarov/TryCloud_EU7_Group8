...
public class talkFunctionalityStepDefs {
    @When("User  Hoover over {string} button from top functionalities bar")
    public void user_Hoover_over_button_from_top_functionalities_bar(String string) {
    ...
    @When("User Selects user name from the {string} list")
    public void user_Selects_user_name_from_the_list(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
